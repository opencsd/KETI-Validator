...
void TableManager::InitCSDTableManager(){
    ...
    table_rep.insert({{"1","lineitem"},"/home/pi/CSD/csd-worker-module/keti/tpch_small_sst/lineitem/000088.sst"});
    table_rep.insert({{"1","customer"},"/home/pi/CSD/csd-worker-module/keti/tpch_small_sst/customer/000644.sst"});
    table_rep.insert({{"1","orders"},"/home/pi/CSD/csd-worker-module/keti/tpch_small_sst/orders/000212.sst"});
    table_rep.insert({{"1","part"},"/home/pi/CSD/csd-worker-module/keti/tpch_small_sst/part/000336.sst"});
    table_rep.insert({{"1","supplier"},"/home/pi/CSD/csd-worker-module/keti/tpch_small_sst/supplier/000768.sst"});
    table_rep.insert({{"1","partsupp"},"/home/pi/CSD/csd-worker-module/keti/tpch_small_sst/partsupp/000460.sst"});
    table_rep.insert({{"1","region"},"/home/pi/CSD/csd-worker-module/keti/tpch_small_sst/region/000584.sst"});
    ...
    table_rep.insert({{"6","supplier"},"/tpch_small_sst/supplier/000831.sst"});l
    ...
    // 1m
    table_rep.insert({{"1","lineitem"},"/home/pi/CSD/csd-worker-module/keti/tpch_1m_no_index_sst/lineitem/002531.sst"});
    table_rep.insert({{"1","customer"},"/home/pi/CSD/csd-worker-module/keti/tpch_1m_no_index_sst/customer/003289.sst"});
    table_rep.insert({{"1","orders"},"/home/pi/CSD/csd-worker-module/keti/tpch_1m_no_index_sst/orders/002655.sst"});
    table_rep.insert({{"1","part"},"/home/pi/CSD/csd-worker-module/keti/tpch_1m_no_index_sst/part/002779.sst"});
    table_rep.insert({{"1","supplier"},"/home/pi/CSD/csd-worker-module/keti/tpch_1m_no_index_sst/supplier/003153.sst"});
    table_rep.insert({{"1","partsupp"},"/home/pi/CSD/csd-worker-module/keti/tpch_1m_no_index_sst/partsupp/002903.sst"});
    table_rep.insert({{"1","region"},"/home/pi/CSD/csd-worker-module/keti/tpch_1m_no_index_sst/region/003027.sst"});
    ...
    //origin
    table_rep.insert({{"1","lineitem"},"/home/pi/CSD/csd-worker-module/keti/tpch_origin_sst/lineitem/A/001379.sst"});
    table_rep.insert({{"1","lineitem"},"/home/pi/CSD/csd-worker-module/keti/tpch_origin_sst/lineitem/B/001382.sst"});
    table_rep.insert({{"1","customer"},"/home/pi/CSD/csd-worker-module/keti/tpch_origin_sst/customer/000644.sst"});
    table_rep.insert({{"1","orders"},"/home/pi/CSD/csd-worker-module/keti/tpch_origin_sst/orders/000290.sst"});
    table_rep.insert({{"1","part"},"/home/pi/CSD/csd-worker-module/keti/tpch_origin_sst/part/003805.sst"});
    table_rep.insert({{"1","supplier"},"/home/pi/CSD/csd-worker-module/keti/tpch_origin_sst/supplier/000788.sst"});
    table_rep.insert({{"1","partsupp"},"/home/pi/CSD/csd-worker-module/keti/tpch_origin_sst/partsupp/000538.sst"});
    table_rep.insert({{"1","region"},"/home/pi/CSD/csd-worker-module/keti/tpch_origin_sst/region/000662.sst"});
